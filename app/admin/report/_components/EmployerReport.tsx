        ...
        <div class="section">
          ...
          <div class="metrics">
            ...
            <div class="metric">
              ...
              <div class="metric-value success">${totalProfit.toLocaleString()}</div>
            </div>
            <div class="metric">
            ...
            <tbody>
              ${employersData.slice(0, 50).map((emp: EmployerItem) => `
                <tr>
                  ...
                  <td>${emp.pump}</td>
                  <td>${emp.role}</td>
                  <td style="color: #14b8a6; font-weight: 600;">Rs. ${salesData.filter(s => s.pump === emp.pump).reduce((sum, s) => sum + s.totalProfit, 0).toLocaleString()}</td>
                  <td>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Generated by all staff</p>
          </CardContent>
        </Card>
              ...
              {employersData.map((employer: EmployerItem, index: number) => (
                <TableRow key={index}>
                  ...
                  <TableCell className="text-success font-semibold">
                    ₨ {salesData.filter(s => s.pump === employer.pump).reduce((sum, s) => sum + s.totalProfit, 0).toLocaleString()}
                  </TableCell>
                  <TableCell>
